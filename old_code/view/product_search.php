...
$keyword =secureRequestParameter($_REQUEST["key"]);


?>

<div class="content">
    <h5>Product Search: <b><?=$keyword?></b></h5>
    <br/>
    <div style="padding: 10px 10px 10px 10px ;">
        ...
        if ($keyword != "") {
            ...
            $productList = $productManager->getProductByKeyword($keyword);
...
<div class='blue_button_box'><a  href='process/shopping_cart_add_process.php?quantity=1&product_id=".$product->get_product_id()."'>Add to Cart</a></div>
            ...
            echo "<p>Please input your search keyword.</p>";
        }
        ?>
    </div>
</div>
