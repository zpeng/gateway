...
insert  into `cms_content`(`content_id`,`content_author_id`,`content_title`,`content_article`,`content_create_date`,`content_last_modify_by`,`content_last_modify_date`,`content_archived`) values (1,1,'Test content','<p>this is testing content</p>','2010-08-13 20:59:17',1,'2013-05-15 15:48:33','N'),(2,1,'test article 2','<p>test article 2</p>','2010-08-13 20:59:17',1,'2013-05-15 13:36:08','N'),(3,1,'33','<p>wwwwww3333</p>','2013-04-08 15:04:06',1,'2013-04-16 16:37:14','N'),(4,1,'this is a new web page','<h2><strong>heheheosdis e</strong></h2>\r\n<h2>&nbsp;</h2>\r\n<h2><strong>deded</strong></h2>\r\n<h2>&nbsp;</h2>\r\n<h2>&nbsp;</h2>\r\n<h2><strong>dede</strong></h2>','2013-04-21 13:19:44',1,'2013-04-21 13:19:44','N');
...
insert  into `ds_category`(`category_id`,`category_parent_id`,`category_name`) values (1,0,'All Categories'),(2,1,'Sports'),(3,1,'Beauty'),(4,1,'New node');
...
insert  into `ds_city`(`city_id`,`city_name`) values (1,'London'),(2,'Edinburgh'),(4,'Glasgow');
...
insert  into `ds_deal`(`deal_id`,`supplier_id`,`category_id`,`city_id`,`deal_title`,`deal_type`,`original_quantity`,`quantity`,`original_price`,`offer_price`,`online_date`,`offline_date`,`fine_print`,`image`,`deal_desc`,`deal_archived`) values (2,1,3,1,'Buy 1 get 1 free','M',100,100,10.00,8.00,'2013-05-07 16:29:04','2013-06-01 12:17:00','','21368454775.jpg','                                                                                                                                                                                                ','N'),(3,2,2,2,'Buy 1 get 1 free','M',100,100,10.00,8.00,'2013-05-07 16:29:04','2013-06-01 12:00:00','<ul>\n<li>term 1</li>\n<li>term 2</li>\n</ul>','31368621107.jpg','<p>descxxxx</p>','N');
...
insert  into `ds_deal_tag`(`tag_id`,`deal_id`) values (1,2),(2,2),(3,2),(3,3),(5,2);
...
insert  into `ds_supplier`(`supplier_id`,`supplier_name`,`supplier_url`,`supplier_logo`,`supplier_email`,`supplier_address`,`supplier_tel`,`supplier_desc`,`supplier_archived`) values (1,'Argos','www.argos.co.uk','default.jpg','argos email','Argos UK','12345678','Argos is a catalogue merchant based in the United Kingdom and Ireland. With about 740 stores, it is the largest general-goods retailer in the UK. Together with sister company Homebase, it today forms part of the Home Retail Group.','N'),(2,'Boots','','default.jpg','','','','','N'),(3,'HMV','http://www.hmv.co.uk/','31366547298.jpg','hmv email','address','1234455','hmv shop','N');
