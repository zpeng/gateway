    ...
    , $JS_DEPS)?>, function () {
            ...
            jQuery(document).ready(function () {
                jQuery("#menu_type_selector").change(function () {
                    $("#menuLevelSelection").load(SERVER_URL + "modules/cms/view/MenuLevelSelection.php?menu_type_id=" + this.value);
                });
                jQuery("#link_type_selector").change(function () {
                    $("#MenuLinkSelection").load(SERVER_URL + "modules/cms/view/MenuLinkSelection.php?link_type_id=" + this.value);
                });
            });
