...
$module_config = array(
    ...
    "php" => array(
        ...
        "DealImageManager" => "modules/deal_steal/includes/classes/DealImageManager.php",
        "DealManager" => "modules/deal_steal/includes/classes/DealManager.php",
        "DealTagManager" => "modules/deal_steal/includes/classes/DealTagManager.php",
        "LoveIt" => "modules/deal_steal/includes/classes/LoveIt.php",
