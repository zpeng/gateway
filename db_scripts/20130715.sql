...
insert  into `cms_content`(`content_id`,`content_author_id`,`content_title`,`content_article`,`content_create_date`,`content_last_modify_by`,`content_last_modify_date`,`content_archived`) values (1,1,'Test content','<p>this is testing content</p>','2010-08-13 20:59:17',1,'2013-05-15 15:48:33','N');
insert  into `cms_content`(`content_id`,`content_author_id`,`content_title`,`content_article`,`content_create_date`,`content_last_modify_by`,`content_last_modify_date`,`content_archived`) values (2,1,'test article 2','<p>test article 2</p>','2010-08-13 20:59:17',1,'2013-05-15 13:36:08','N');
insert  into `cms_content`(`content_id`,`content_author_id`,`content_title`,`content_article`,`content_create_date`,`content_last_modify_by`,`content_last_modify_date`,`content_archived`) values (3,1,'33','<p>wwwwww3333</p>','2013-04-08 15:04:06',1,'2013-04-16 16:37:14','N');
insert  into `cms_content`(`content_id`,`content_author_id`,`content_title`,`content_article`,`content_create_date`,`content_last_modify_by`,`content_last_modify_date`,`content_archived`) values (4,1,'this is a new web page','<h2><strong>heheheosdis e</strong></h2>\r\n<h2>&nbsp;</h2>\r\n<h2><strong>deded</strong></h2>\r\n<h2>&nbsp;</h2>\r\n<h2>&nbsp;</h2>\r\n<h2><strong>dede</strong></h2>','2013-04-21 13:19:44',1,'2013-04-21 13:19:44','N');
...
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (1,0,1,3,'www.google.com','Google','test','N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (2,1,1,3,'index.php?view=product_onsale','test1','this is a testingeeee','N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (3,1,1,3,'customer.php?view=order_history','test2',NULL,'N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (4,3,1,4,'index.php?content_id=1&view=content&title=Delivery-Policy','test3',NULL,'N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (5,0,1,5,'index.php?content_id=2&view=content&title=Contact-Us','test4',NULL,'N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (6,5,1,3,'http://www.ziyangluyao.com','Google Testing','','Y');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (7,0,1,10,'','Content link testing','','Y');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (8,0,1,10,'index.php?view=cms&article_id=2','My yes','','Y');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (9,1,1,1,'index.php?view=cms&article_id=2','treeee','','N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (10,9,1,1,'index.php?view=cms&article_id=4','real madird','','N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (11,4,1,3,'index.php?view=cms&article_id=','ok it is','','N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (12,1,1,11,'http://','dede','','N');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (13,0,1,22,'http://','dede222','','Y');
insert  into `cms_menu`(`menu_id`,`menu_parent_id`,`menu_type_id`,`menu_order`,`menu_link`,`menu_name`,`menu_desc`,`menu_archived`) values (14,0,1,14,'http://test','test test test','','Y');
...
insert  into `cms_menu_type`(`menu_type_id`,`menu_type_name`,`menu_type_description`,`menu_type_archived`) values (1,'Top Menu','Top Menu','N');
insert  into `cms_menu_type`(`menu_type_id`,`menu_type_name`,`menu_type_description`,`menu_type_archived`) values (2,'Bottom Menu','Bottom Menu','N');
...
insert  into `core_module`(`module_code`,`module_name`,`module_desc`,`module_archived`) values ('390fc605ba6c4010cb26794169636add','Content Manager','The Content Management System','N');
insert  into `core_module`(`module_code`,`module_name`,`module_desc`,`module_archived`) values ('a74ad8dfacd4f985eb3977517615ce25','System Core','The Core Module','N');
insert  into `core_module`(`module_code`,`module_name`,`module_desc`,`module_archived`) values ('b3a92844510a267ca17eef7e5ba703c9','Deal Steal','The Deal Steal Module','N');
...
insert  into `core_user`(`user_id`,`user_name`,`user_password`,`user_archived`) values (1,'pengziyang@gmail.com','ae38f3e59310c930f2f9ebcfc9497499','N');
insert  into `core_user`(`user_id`,`user_name`,`user_password`,`user_archived`) values (2,'zpeng@gmail.com','ae38f3e59310c930f2f9ebcfc9497499','N');
insert  into `core_user`(`user_id`,`user_name`,`user_password`,`user_archived`) values (5,'lyla.holy@gmail.com','ae38f3e59310c930f2f9ebcfc9497499','N');
insert  into `core_user`(`user_id`,`user_name`,`user_password`,`user_archived`) values (7,'pengshiqun@gmail.com','ae38f3e59310c930f2f9ebcfc9497499','N');
...
insert  into `ds_category`(`category_id`,`category_parent_id`,`category_name`) values (4,1,'New node');
...
insert  into `ds_city`(`city_id`,`city_name`) values (1,'London');
insert  into `ds_city`(`city_id`,`city_name`) values (2,'Edinburgh');
insert  into `ds_city`(`city_id`,`city_name`) values (4,'Glasgow');
...
insert  into `ds_deal`(`deal_id`,`supplier_id`,`category_id`,`city_id`,`deal_title`,`deal_type`,`original_quantity`,`quantity`,`original_price`,`offer_price`,`online_date`,`offline_date`,`fine_print`,`image`,`deal_desc`,`deal_archived`) values (2,1,3,1,'Buy 1 get 1 free','D',100,100,10.00,8.00,'2013-05-07 16:29:04','2013-06-01 12:17:00','','21368454775.jpg','                                                                                                                                                                                                ','N');
insert  into `ds_deal`(`deal_id`,`supplier_id`,`category_id`,`city_id`,`deal_title`,`deal_type`,`original_quantity`,`quantity`,`original_price`,`offer_price`,`online_date`,`offline_date`,`fine_print`,`image`,`deal_desc`,`deal_archived`) values (3,2,2,2,'Half Price Promotion, Boots','D',100,100,30.00,14.99,'2013-05-07 16:29:04','2013-06-01 12:00:00','<ul>\n<li>term 1</li>\n<li>term 2</li>\n</ul>','31369061225.jpg','<p>descxxxx</p>','N');
...
insert  into `ds_supplier`(`supplier_id`,`supplier_name`,`supplier_url`,`supplier_logo`,`supplier_email`,`supplier_address`,`supplier_tel`,`supplier_desc`,`supplier_archived`) values (1,'Argos','www.argos.co.uk','11368984528.jpg','argos email','Argos UK','12345678','<p>Argos&nbsp;</p>','N');
insert  into `ds_supplier`(`supplier_id`,`supplier_name`,`supplier_url`,`supplier_logo`,`supplier_email`,`supplier_address`,`supplier_tel`,`supplier_desc`,`supplier_archived`) values (2,'Boots','','21368984545.png','','','','','N');
insert  into `ds_supplier`(`supplier_id`,`supplier_name`,`supplier_url`,`supplier_logo`,`supplier_email`,`supplier_address`,`supplier_tel`,`supplier_desc`,`supplier_archived`) values (3,'HMV','http://www.hmv.co.uk/','31368984557.jpg','hmv email','address','1234455','hmv shop','N');
insert  into `ds_supplier`(`supplier_id`,`supplier_name`,`supplier_url`,`supplier_logo`,`supplier_email`,`supplier_address`,`supplier_tel`,`supplier_desc`,`supplier_archived`) values (4,'Pizza Hut&#8206;','','41369055129.png','','','','','N');
...
insert  into `ds_tag`(`tag_id`,`tag_value`) values (6,'c#');
